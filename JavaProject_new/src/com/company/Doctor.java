...
public class Doctor {
    ...
    public String addInformation(){
        return "INSERT INTO Doctor(idDoctor, firstNameDoctor, lastNameDoctor, costPerVisit, qualification) " +
                "VALUES (1,'Harry', 'Potter', 2000,'Psychologist'),"  +
                "(2, 'Adam', 'Sandler', 5000,'Allergist'), " +
                "(3, 'George', 'Hype', 8000,'Cardiologist'), " +
                "(4, 'Papa', 'Timmie', 40000,'Surgeon'), " +
                "(5, 'Mama', 'Black', 5000,'Dermatologist') ";
    }
